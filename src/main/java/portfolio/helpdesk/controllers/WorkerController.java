...
public class WorkerController {
    ...
    public ResponseEntity<Void> save(@Valid @RequestBody WorkerRequestDTO workerRequestDTO) {
        userService.findUserByUsernameOrEmail(workerRequestDTO.username(), workerRequestDTO.email());
        Worker worker = workerService.save(workerMapper.convertToEntity(workerRequestDTO));
